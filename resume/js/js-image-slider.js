        ...
        for (
            var T = function (a) {
                return document.getElementById(a)
                    ...
                    }, Lb = document, U = window.requestAnimationFrame, db = window.cancelAnimationFrame, kb = ["webkit", "ms", "o"], cb = 0;
                cb < kb[d] && !U;
                ++cb) {
            ...
            var l = new E, ob = function () {
                ...
                c: function () {
                    ...
                    else b.e = lb(e[b.a], "img")[0]; if (e[b.a][o] == "A" || e[b.a][g] == "video") e[b.a][c][y] = "block";
                    ...
                    while (a--) {
                        ...
                        else d[a][g] = ""; if (e[a][o] == "A" || e[a][g] == "video") e[a][c][y] = a == b.a ? "block" : "none"
                    }
                }, i: function () {
                    O = A("mc-caption");
                    W = A("mc-caption");
                    ...
                    if (a[o] != "IMG") {
                        if (a[o] == "A") var d = a[h]("href"),
                            ...
                            } else a[q].replaceChild(b, a); if (i) e[j] = b
                        }
                    }
                }, p: function (i) {
                    if (e[b.a][o] == "IMG") b.e = e[b.a];
